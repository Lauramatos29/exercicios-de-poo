...
public class PokemonAgua extends Pokemon {
	...
	public PokemonAgua(String nome, String tipo, int hp, int ataque, int defesa, int velocidade) {
			    ...
			    switch (escolha) {
			        case 1:
			        	try {
			                ...
			                if ("Fogo".equals(oponente.getTipo())) {
			                ...
			                else if("Planta".equals(oponente.getTipo())) {
			                	int dano = (10 + ataque - oponente.getDefesa())/2;
			                	oponente.setHp(oponente.getHp() - dano); 
			                	System.out.println("O oponente tomou " + dano + " de dano");
			                }
			        ...
			        case 2:
			        	try {
			                ...
			                if ("Fogo".equals(oponente.getTipo())) {
			                	...
			                	oponente.setHp(oponente.getHp() - dano); 
			                	System.out.println(oponente.getHp());
			                	System.out.println("O oponente tomou " + dano + " de dano");
			                }
			        	} catch (IllegalArgumentException e) {
			        		System.out.println("Erro: " + e.getMessage());
