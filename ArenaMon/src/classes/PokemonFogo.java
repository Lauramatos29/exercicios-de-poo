...
public class PokemonFogo extends Pokemon {
	...
	public PokemonFogo(String nome, String tipo, int hp, int ataque, int defesa, int velocidade) {
			    ...
			    switch (escolha) {
			        case 1:
			        	try {
			                ...
			                if ("Planta".equals(oponente.getTipo())) {
			                ...
			                else if("Agua".equals(oponente.getTipo())) {
			                	int dano = (10 + ataque - oponente.getDefesa())/2;
			                	oponente.setHp(oponente.getHp() - dano); 
			                	System.out.println("O oponente tomou " + dano + " de dano");
			                }
